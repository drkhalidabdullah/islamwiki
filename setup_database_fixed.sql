-- IslamWiki Comprehensive Database Schema
...
CREATE TABLE `translations` (
    ...
    `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    UNIQUE KEY `unique_translation` (`language_code`, `key`, `context`),
...
-- Insert default languages (without emoji flags)
INSERT INTO `languages` (`code`, `name`, `native_name`, `flag`, `is_active`, `sort_order`) VALUES
('en', 'English', 'English', 'US', 1, 1),
('ar', 'Arabic', 'العربية', 'SA', 1, 2),
('ur', 'Urdu', 'اردو', 'PK', 1, 3),
('tr', 'Turkish', 'Türkçe', 'TR', 1, 4),
('fr', 'French', 'Français', 'FR', 1, 5),
('es', 'Spanish', 'Español', 'ES', 1, 6);

-- Insert default admin user
INSERT INTO `users` (`username`, `email`, `password_hash`, `first_name`, `last_name`, `display_name`, `is_active`) 
VALUES ('admin', 'admin@islamwiki.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Admin', 'User', 'Administrator', 1);
