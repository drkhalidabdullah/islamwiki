-- IslamWiki Database Migration v0.0.0.7
...
-- Add user profile search indexes
ALTER TABLE `user_profiles` 
ADD INDEX `idx_search_bio` (`bio`(255));

-- Add message search indexes (if messages table exists)
-- Note: This will only work if the messages table was created in v0.0.0.5
