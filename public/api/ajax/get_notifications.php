...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        JOIN user_follows uf ON uf.user_id = ? AND uf.following_id = u.id
        LEFT JOIN (
    ...
    foreach ($posts as $post) {
        $notifications[] = [
            ...
            'content' => $post['title'] ?: substr(strip_tags($post['content']), 0, 100) . (strlen(strip_tags($post['content'])) > 100 ? '...' : ''),
            'avatar' => $post['avatar'] ?: '/assets/images/default-avatar.png',
    ...
    foreach ($articles as $article) {
        $notifications[] = [
            ...
            'avatar' => $article['avatar'] ?: '/assets/images/default-avatar.png',
    ...
    foreach ($interactions as $interaction) {
        ...
        $notifications[] = [
            ...
            'avatar' => $interaction['avatar'] ?: '/assets/images/default-avatar.png',
    ...
    foreach ($followers as $follower) {
        $notifications[] = [
            ...
            'content' => '',
            'avatar' => $follower['avatar'] ?: '/assets/images/default-avatar.png',
