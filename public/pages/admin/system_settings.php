                ...
                <div class="card maintenance-mode-card">
                    ...
                    <form method="POST">
                        ...
                        <div class="maintenance-toggle-section">
                            ...
                            <div class="maintenance-settings" id="maintenance-settings" style="margin-top: 2rem; padding: 1.5rem; background: #f8f9fa; border-radius: 8px; border: 1px solid #e9ecef; display: none;">
